    ...
    Protected.prototype = {
        ...
        messages: {
            ...
            en: {
                ...
                companyName: {
                    ...
                    incorrect: 'Incorrect Company name'
                },
        ...
        rules: {
            ...
            name: function(value) {
                ...
                return new RegExp(/^[a-zA-Z\sа-яА-Яêãõêãâá\']+$/g).test(value);
            },
            ...
            companyName: function(value) {
                ...
                return new RegExp(/^[a-zA-Z\sа-яА-Яêãõêãâá\'ã\,â\-]+$/g).test(value);
            },
            ...
            phone: function(value) {
                if (value.replace(/[^0-9]+/gi, '').match(/[0-9]+/gi) && value.replace(/[^0-9]+/gi, '').match(/[0-9]+/gi)[0].length != 9 || value < 1) {
                    return false;
                }
