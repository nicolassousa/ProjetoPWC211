...
(function (root) {
	...
	Protected.prototype = {
		...
		messages: {
		    ...
		    en: {
		        required: {
		            empty: 'Preenchimento obrigatório',
		            incorrect: 'Valor inválido'
		        },
		        notzero: {
		            empty: 'Por favor, selecione um campo',
		            incorrect: 'Valor inválido'
		        },
		        integer: {
		            empty: 'Insira um inteiro válido',
		            incorrect: 'Valor inválido'
		        },
		        float: {
		            empty: 'Insira um número válido',
		            incorrect: 'Valor inválido'
		        },
		        min: {
		            empty: 'Enter more',
		        ...
		        name: {
		            empty: 'Por favor, insira um nome válido',
		            incorrect: 'Nome inválido'
		        },
		        lastname: {
		        ...
		        phone: {
		            empty: 'Por favor, insira o seu contacto',
		            incorrect: 'Contacto inválido'
		        },
		        email: {
		            empty: 'Por favor, insira o seu endereço de email',
		            incorrect: 'Endereço de email inválido'
		        },
		        length: {
		        ...
		        minlength: {
		            empty: 'Por favor, insira um valor de, pelo menos, 2 caracteres',
		            incorrect: 'Inseriu um valor com menos de 2 caracteres'
		        },
		        maxlength: {
		...
		rules: {
		    ...
		    phone: function (value) {
		        if (value.replace(/[^0-9]+/gi, '').match(/[0-9]+/gi) && value.replace(/[^0-9]+/gi, '').match(/[0-9]+/gi)[0].length < 9) {
		            return false;
		        }
